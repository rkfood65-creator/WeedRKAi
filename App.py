...
# మీ అసలైన వర్కింగ్ జెమిని API కీ ఇక్కడ యాడ్ చేయబడింది
GOOGLE_API_KEY = "AQ.Ab8RN6JsM0X0JUYImwKPG2um-u2tkD59FpC-wU_NP5TYehJJVw"
...
if user_question := st.chat_input("Ask a question..."):
    ...
    with st.chat_message("assistant"):
        ...
        try:
            ...
            full_response = "Error connecting to the server. Please check the API key configuration."
            message_placeholder.markdown(full_response)
